  ...
  return (
    <section className="bg-cian-main min-h-screen font-comfortaa pb-20">
      ...
      <div className="bg-white rounded-t-[2.5rem]">
        <Link to="/settings">
          <ButtonMain text="" style="" />
          <IconSettings className="bg-cian-secondary rounded-full h-9 w-9 absolute right-3 top-32 text-white p-1" />
        </Link>

        <div className="py-5">
          <div className="flex gap-3 justify-center items-end pb-3">
            <ProfileAvatar
              imageUrl="./src/assets/fotoPerfil2.png"
              altText="Linked Profile"
              type="linked"
            />
            <ProfileAvatar
              imageUrl="./src/assets/fotoPerfil.png"
              altText="Main Profile"
              type="main"
            />
        ...
        <div className="grid grid-cols-2 gap-4 px-10 py-5">
          <Link to="/medicines">
            <MediumWidget
              title="Medicamentos"
              icon="./src/assets/medicines-orange.svg"
            />
          </Link>
          <Link to="/medicalregister">
            <MediumWidget
              title="Registro Médico"
              icon="./src/assets/medical-record-orange.svg"
            />
          </Link>
        </div>
        ...
        <div className="grid gap-4 px-10 py-5">
          <ButtonMain
            style="bg-cian-secondary p-3 rounded-lg text-xs"
