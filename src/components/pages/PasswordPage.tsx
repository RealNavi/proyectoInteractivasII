                            ...
                            <section className="flex-col justify-center items-center bg-white mt-40">
                                ...
                                <section className="h-screen flex-coljustify-center items-center bg-grey-light rounded-t-4xl">
                                    ...
                                    <div className="flex items-center justify-center mt-10 space-x-10">
                                        <ButtonMain style="font-confortaa bg-orange-main text-xs rounded-4xl py-3 px-13 hover:bg-orange-light" text={props.button1}/>
                                        <ButtonMain style="font-confortaa bg-orange-main text-xs rounded-4xl py-3 px-13 hover:bg-orange-light" text={props.button2}/>
                                    </div>
                                </section>
                            </section>
                        </section>
